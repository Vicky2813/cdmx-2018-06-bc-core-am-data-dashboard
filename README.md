...
Nombre: Lucile
Genero: Femenino
Puesto: Training Managers (TMs)
Sede: Mexico (CDMX)


### Definición del producto
Para conocer un poco más en cuanto a las nececidades del producto, se realizo una entrevista (https://www.youtube.com/watch?v=ihvJ8wsalj4&index=14&list=WL&t=0s) a nuestro usuario principal, en donde observamos que como primer objetivo tiene la consulta de la data, por ello es relevante que la información que se muestre primero sea la de cada sede, se pueda percibir a simple vista y sea facil de entender, además de que la interacción con dicha información se realiza diariamente y en distintos dispositivos.
La creación de esta interfaz pretende resolver la consulta de la información, ya que las herramientas que utilizan (excel) en este momento son un tanto deficientes en cuanto a la manipulación de la data.
